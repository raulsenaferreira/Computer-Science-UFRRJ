package br.ufrrj.im.cc.ed2.projections.author;
...
import br.ufrrj.im.cc.ed2.projections.Projection;

public class ProjectionAuthor implements Projection{
	...
	public static void main(String[] args) {
		ProjectionAuthor pa = new ProjectionAuthor("Luis Fernando Orleans");
		
		System.out.println(pa.custoJuncaoSelecao().custo());
	}
	
	
	public ProjectionAuthor(String an){
		book = new Relacao("Livro");
		author = new Relacao("Autor");
		Selecao sel = new Selecao(author, an, "nome");
		sel.open();
		Tupla linha = (Tupla) sel.next();
